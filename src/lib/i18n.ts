...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    goBack: 'Go back',
    newTemplateDefault: 'New Template',
    more: 'more',
    manageFiles: 'Manage Files',
    files: 'Files',
    noFilesFound: 'No files found for this client.',
    openFolder: 'Open Folder',
    rename: 'Rename',
    preview: 'Preview',
    fileName: 'File Name',
    renameFile: 'Rename File',
    supportedTypes: 'Supported types: .pdf, .docx',
  ...
  pt: {
    ...
    checkboxLabel: 'Texto da Caixa de Seleção',
    ...
    goBack: 'Voltar',
    newTemplateDefault: 'Novo Modelo',
    more: 'mais',
    manageFiles: 'Gerenciar Arquivos',
    files: 'Arquivos',
    noFilesFound: 'Nenhum arquivo encontrado para este cliente.',
    openFolder: 'Abrir Pasta',
    rename: 'Renomear',
    preview: 'Pré-visualizar',
    fileName: 'Nome do Arquivo',
    renameFile: 'Renomear Arquivo',
    supportedTypes: 'Tipos suportados: .pdf, .docx',
